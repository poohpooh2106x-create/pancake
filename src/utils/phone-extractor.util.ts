import { ExtractedPhoneNumber } from '../types/customer.types';
 ...
 */
export function convertThaiDigitsToArabic(text: string): string {
 ...
 */
export function normalizeThaiPhoneNumber(rawPhone: string): {
  normalized: string;
  e164: string;
  isMobile: boolean;
} | null {
 ...
 */
export function extractThaiPhoneNumbers(rawText: string | undefined | null): ExtractedPhoneNumber[] {
